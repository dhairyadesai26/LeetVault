...
import { siFacebook, siApple, siNetflix, siGoogle } from 'simple-icons';
      ...
      <main className={styles.mainContent}>
        ...
        >
          ...
          <div className={styles.faangContainer}>
            <p className={styles.faangText}>Prepare for</p>
            <div className={styles.faangLogosRow}>
              <svg role="img" viewBox="0 0 24 24" className={styles.faangIcon} style={{fill: '#1877F2'}}><path d={siFacebook.path}/></svg>
              <svg role="img" viewBox="0 0 24 24" className={styles.faangIcon} style={{fill: '#ffffff'}}><path d={siApple.path}/></svg>
              <svg role="img" viewBox="0 0 16 16" className={styles.faangIcon} style={{fill: '#FF9900'}}>
              ...
              <svg role="img" viewBox="0 0 24 24" className={styles.faangIcon} style={{fill: '#E50914'}}><path d={siNetflix.path}/></svg>
              <svg role="img" viewBox="0 0 24 24" className={styles.faangIcon} style={{fill: '#4285F4'}}><path d={siGoogle.path}/></svg>
            </div>
          </div>
